...
# Scene
m.loadScene('VPLMedia/BNVTest/BNVTest.pyscene')
...
m.scene.camera.position = float3(1.691830,0.897967,-0.577950)
m.scene.camera.target = float3(1.954984,0.878672,-1.542510)
m.scene.camera.up = float3(-0.000100,0.999900,-0.001000)
